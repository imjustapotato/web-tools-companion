...
# Documentations
- [Auto Plotter Flow](authflow.md) - The synchronization architecture between the Web Tools Companion Extension, the FEU Tech School Portal (OSES), and the Schedule Visualizer (Web Tool).
